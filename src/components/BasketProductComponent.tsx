...
const BasketProductComponent:React.FC <BasketProductInterfaceProps> = ({id, title, price, count, imageUrl, size, type}) => {
  ...
  return (
    ...
    <div className="cart__item-count">
      <div className="button button--outline button--circle cart__item-count-minus" onClick={onRemoveProduct}>
        <svg
          width="10"
          height="10"
          viewBox="0 0 10 10"
      ...
      <b>{count}</b>
      <div className="button button--outline button--circle cart__item-count-plus" onClick={onAddProduct}>
        <svg
          width="10"
          height="10"
          viewBox="0 0 10 10"
    ...
    <div className="cart__item-remove">
      <div className="button button--outline button--circle" onClick={onRemoveProducts}>
        <svg
          width="10"
          height="10"
          viewBox="0 0 10 10"
