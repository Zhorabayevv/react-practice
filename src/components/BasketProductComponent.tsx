...
const BasketProductComponent: React.FC<BasketProductInterfaceProps> = ({
  id,
  title,
  price,
  count,
  ...
  const onAddProduct = () => {
    dispatch(addProduct({ id } as ProductInterface));
  };
  const onRemoveProduct = () => {
    dispatch(removeProduct({ id } as ProductInterface));
  };
